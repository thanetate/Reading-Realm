...
function Settings() {
    //i am using single page rendering for the different tabs in settings
    ...
    <>
        <div className="settings-page-container">
            ...
            <div className="left-nav">
                ...
                <button className="nav-container" onClick={() => handleNavigation('account-preferences')}>
                    <div className="nav-img"><img src="/icons/profile.svg" alt="profile icon" /></div>
                    <div className="nav-name">Account Preferences</div>
                </button>
                <button className="nav-container" onClick={() => handleNavigation('sign-in-security')}>
                    <div className="nav-img"><img src="/icons/security.svg" alt="security icon" /></div>
